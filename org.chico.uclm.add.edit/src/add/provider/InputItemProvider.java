...
/**
 * This is the item provider adapter for a {@link add.Input} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputItemProvider extends NodeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AddPackage.Literals.INPUT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AddPackage.Literals.INPUT__INTERACTION);
			childrenFeatures.add(AddPackage.Literals.INPUT__TEMPORALITY);
			childrenFeatures.add(AddPackage.Literals.INPUT__EVENT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AddPackage.Literals.INPUT__INTERACTION,
				 AddFactory.eINSTANCE.createInteraction()));

		newChildDescriptors.add
			(createChildParameter
				(AddPackage.Literals.INPUT__TEMPORALITY,
				 AddFactory.eINSTANCE.createTime()));

		newChildDescriptors.add
			(createChildParameter
				(AddPackage.Literals.INPUT__EVENT,
				 AddFactory.eINSTANCE.createEvent()));
	}
