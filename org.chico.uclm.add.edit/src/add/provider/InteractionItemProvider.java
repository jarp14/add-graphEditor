...
/**
 * This is the item provider adapter for a {@link add.Interaction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InteractionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interaction_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interaction_text_feature", "_UI_Interaction_type"),
				 AddPackage.Literals.INTERACTION__TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Interaction)object).getText();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Interaction.class)) {
			case AddPackage.INTERACTION__TEXT:
