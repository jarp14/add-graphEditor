...
/**
 * This is the item provider adapter for a {@link add.Time} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Time_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Time_text_feature", "_UI_Time_type"),
				 AddPackage.Literals.TIME__TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Time)object).getText();
