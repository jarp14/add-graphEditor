...
/**
 * This is the item provider adapter for a {@link add.Output} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutputItemProvider extends NodeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AddPackage.Literals.OUTPUT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AddPackage.Literals.OUTPUT__TEMPORALITY);
			childrenFeatures.add(AddPackage.Literals.OUTPUT__OPERATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AddPackage.Literals.OUTPUT__TEMPORALITY,
				 AddFactory.eINSTANCE.createTime()));

		newChildDescriptors.add
			(createChildParameter
				(AddPackage.Literals.OUTPUT__OPERATION,
				 AddFactory.eINSTANCE.createOperation()));
	}
