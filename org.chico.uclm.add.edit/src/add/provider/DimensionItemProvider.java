...
/**
 * This is the item provider adapter for a {@link add.Dimension} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DimensionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dimension_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dimension_text_feature", "_UI_Dimension_type"),
				 AddPackage.Literals.DIMENSION__TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Dimension)object).getText();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Dimension.class)) {
			case AddPackage.DIMENSION__TEXT:
