...
/**
 * This is the item provider adapter for a {@link add.Area} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AreaItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Area_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Area_text_feature", "_UI_Area_type"),
				 AddPackage.Literals.AREA__TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Area)object).getText();
