...
public class InteractionCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		Input container = (Input) getElementToEdit();
		if (container.getInteraction() != null) {
			return false;
		}
		return true;
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		Interaction newElement = AddFactory.eINSTANCE.createInteraction();

		Input owner = (Input) getElementToEdit();
		owner.setInteraction(newElement);
