 ...
 * @generated
 */
public class SolidLinkReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public SolidLinkReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof SolidLink) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return AddBaseItemSemanticEditPolicy.getLinkConstraints().canExistSolidLink_4002(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		ADDDiagram container = (ADDDiagram) getLink().eContainer();
		return AddBaseItemSemanticEditPolicy.getLinkConstraints().canExistSolidLink_4002(container, getLink(), source,
				getNewTarget());
	}
	...
	* @generated
	*/
	protected SolidLink getLink() {
		return (SolidLink) getElementToEdit();
	}
