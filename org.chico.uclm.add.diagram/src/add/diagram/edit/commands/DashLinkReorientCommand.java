 ...
 * @generated
 */
public class DashLinkReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public DashLinkReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof DashLink) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return AddBaseItemSemanticEditPolicy.getLinkConstraints().canExistDashLink_4004(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		ADDDiagram container = (ADDDiagram) getLink().eContainer();
		return AddBaseItemSemanticEditPolicy.getLinkConstraints().canExistDashLink_4004(container, getLink(), source,
				getNewTarget());
	}
	...
	* @generated
	*/
	protected DashLink getLink() {
		return (DashLink) getElementToEdit();
	}
