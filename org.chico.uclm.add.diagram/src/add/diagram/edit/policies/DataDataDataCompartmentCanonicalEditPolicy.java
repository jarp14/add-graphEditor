 ...
 * @generated
 */
public class DataDataDataCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return AddPackage.eINSTANCE.getData_Data();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<AddNodeDescriptor> childDescriptors = AddDiagramUpdater
				.getDataDataDataCompartment_7006SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return DataxEditPart.VISUAL_ID == AddVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<AddNodeDescriptor> childDescriptors = AddDiagramUpdater
				.getDataDataDataCompartment_7006SemanticChildren((View) getHost().getModel());
