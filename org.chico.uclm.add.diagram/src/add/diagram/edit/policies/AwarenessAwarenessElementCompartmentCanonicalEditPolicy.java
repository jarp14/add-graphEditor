 ...
 * @generated
 */
public class AwarenessAwarenessElementCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return AddPackage.eINSTANCE.getAwareness_Element();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<AddNodeDescriptor> childDescriptors = AddDiagramUpdater
				.getAwarenessAwarenessElementCompartment_7009SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ElementEditPart.VISUAL_ID == AddVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<AddNodeDescriptor> childDescriptors = AddDiagramUpdater
				.getAwarenessAwarenessElementCompartment_7009SemanticChildren((View) getHost().getModel());
