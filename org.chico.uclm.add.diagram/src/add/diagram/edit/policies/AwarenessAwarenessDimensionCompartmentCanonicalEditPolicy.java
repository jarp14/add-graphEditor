 ...
 * @generated
 */
public class AwarenessAwarenessDimensionCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return AddPackage.eINSTANCE.getAwareness_Dimension();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<AddNodeDescriptor> childDescriptors = AddDiagramUpdater
				.getAwarenessAwarenessDimensionCompartment_7008SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return DimensionEditPart.VISUAL_ID == AddVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<AddNodeDescriptor> childDescriptors = AddDiagramUpdater
				.getAwarenessAwarenessDimensionCompartment_7008SemanticChildren((View) getHost().getModel());
