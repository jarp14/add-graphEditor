 ...
 * @generated
 */
public class InputInputInteractionCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return AddPackage.eINSTANCE.getInput_Interaction();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<AddNodeDescriptor> childDescriptors = AddDiagramUpdater
				.getInputInputInteractionCompartment_7001SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return InteractionEditPart.VISUAL_ID == AddVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<AddNodeDescriptor> childDescriptors = AddDiagramUpdater
				.getInputInputInteractionCompartment_7001SemanticChildren((View) getHost().getModel());
