 ...
 * @generated
 */
public class OutputOutputTemporalityCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return AddPackage.eINSTANCE.getOutput_Temporality();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<AddNodeDescriptor> childDescriptors = AddDiagramUpdater
				.getOutputOutputTemporalityCompartment_7004SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Time2EditPart.VISUAL_ID == AddVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<AddNodeDescriptor> childDescriptors = AddDiagramUpdater
				.getOutputOutputTemporalityCompartment_7004SemanticChildren((View) getHost().getModel());
