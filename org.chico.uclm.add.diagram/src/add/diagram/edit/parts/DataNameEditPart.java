...
public class DataNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Data_2009, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.DataNameEditPart.VISUAL_ID));
		}
		return parser;
	}
