 ...
 * @generated
 */
public class TimeTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TimeTextEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Time_3002, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.TimeTextEditPart.VISUAL_ID));
		}
		return parser;
	}
