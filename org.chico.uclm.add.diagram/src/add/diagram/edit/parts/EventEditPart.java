...
import add.diagram.edit.policies.EventItemSemanticEditPolicy;
...
public class EventEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EventTextEditPart) {
			((EventTextEditPart) childEditPart).setLabel(getPrimaryShape().getFigureEventLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(AddVisualIDRegistry.getType(EventTextEditPart.VISUAL_ID));
	}
