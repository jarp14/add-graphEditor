 ...
 * @generated
 */
public class DimensionTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DimensionTextEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Dimension_3008, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.DimensionTextEditPart.VISUAL_ID));
		}
		return parser;
	}
