...
public class DeviceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Device_2012, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.DeviceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
