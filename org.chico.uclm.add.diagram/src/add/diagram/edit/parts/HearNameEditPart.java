 ...
 * @generated
 */
public class HearNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(AddVisualIDRegistry.getType(add.diagram.edit.parts.HearNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public HearNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Hear_2004, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.HearNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new HearLabelFigure();
	}

	/**
	 * @generated
	 */
	public class HearLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public HearLabelFigure() {
			this.setText("Hear");
		}
