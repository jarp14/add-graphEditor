 ...
 * @generated
 */
public class AreaTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AreaTextEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Area_3007, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.AreaTextEditPart.VISUAL_ID));
		}
		return parser;
	}
