 ...
 * @generated
 */
public class OperationTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public OperationTextEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Operation_3005, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.OperationTextEditPart.VISUAL_ID));
		}
		return parser;
	}
