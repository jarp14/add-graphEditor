 ...
 * @generated
 */
public class InteractionTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InteractionTextEditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return AddElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Interaction_3001, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.InteractionTextEditPart.VISUAL_ID));
		}
		return parser;
	}
