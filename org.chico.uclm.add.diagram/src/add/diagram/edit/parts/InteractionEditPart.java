...
import add.diagram.edit.policies.InteractionItemSemanticEditPolicy;
...
public class InteractionEditPart extends ShapeNodeEditPart {
	...
	*/
	protected IFigure createNodeShape() {
		return primaryShape = new InteractionFigure();
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InteractionTextEditPart) {
			((InteractionTextEditPart) childEditPart).setLabel(getPrimaryShape().getFigureInteractionLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(AddVisualIDRegistry.getType(InteractionTextEditPart.VISUAL_ID));
	}
	...
	public class InteractionFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureInteractionLabelFigure.setText("Interaction");

			this.add(fFigureInteractionLabelFigure);
