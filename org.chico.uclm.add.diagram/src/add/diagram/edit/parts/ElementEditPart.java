...
import add.diagram.edit.policies.ElementItemSemanticEditPolicy;
...
public class ElementEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ElementTextEditPart) {
			((ElementTextEditPart) childEditPart).setLabel(getPrimaryShape().getFigureElementLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(AddVisualIDRegistry.getType(ElementTextEditPart.VISUAL_ID));
	}
