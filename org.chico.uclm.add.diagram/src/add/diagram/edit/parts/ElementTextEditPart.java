 ...
 * @generated
 */
public class ElementTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ElementTextEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Element_3009, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.ElementTextEditPart.VISUAL_ID));
		}
		return parser;
	}
