 ...
 * @generated
 */
public class TouchNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(AddVisualIDRegistry.getType(add.diagram.edit.parts.TouchNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public TouchNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Touch_2002, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.TouchNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new TouchLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TouchLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TouchLabelFigure() {
			this.setText("Touch");
		}
