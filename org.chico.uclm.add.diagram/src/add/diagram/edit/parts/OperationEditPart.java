...
import add.diagram.edit.policies.OperationItemSemanticEditPolicy;
...
public class OperationEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OperationTextEditPart) {
			((OperationTextEditPart) childEditPart).setLabel(getPrimaryShape().getFigureOperationLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(AddVisualIDRegistry.getType(OperationTextEditPart.VISUAL_ID));
	}
