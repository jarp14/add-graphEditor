 ...
 * @generated
 */
public class FlowNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(AddVisualIDRegistry.getType(add.diagram.edit.parts.FlowNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Flow_2015, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.FlowNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new FlowLabelFigure();
	}

	/**
	 * @generated
	 */
	public class FlowLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public FlowLabelFigure() {
			this.setText("Flow");
		}
