 ...
 * @generated
 */
public class SmellNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(AddVisualIDRegistry.getType(add.diagram.edit.parts.SmellNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public SmellNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Smell_2005, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.SmellNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new SmellLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SmellLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SmellLabelFigure() {
			this.setText("Smell");
		}
