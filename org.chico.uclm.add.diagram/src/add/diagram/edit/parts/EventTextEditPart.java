 ...
 * @generated
 */
public class EventTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EventTextEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Event_3003, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.EventTextEditPart.VISUAL_ID));
		}
		return parser;
	}
