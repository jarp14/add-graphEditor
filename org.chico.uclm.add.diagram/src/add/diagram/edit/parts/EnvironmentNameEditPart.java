...
import add.diagram.edit.policies.AddTextSelectionEditPolicy;
 ...
 * @generated
 */
public class EnvironmentNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(AddVisualIDRegistry.getType(add.diagram.edit.parts.EnvironmentNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new AddTextSelectionEditPolicy());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Environment_2006, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.EnvironmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, AddEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new EnvironmentLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EnvironmentLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EnvironmentLabelFigure() {
