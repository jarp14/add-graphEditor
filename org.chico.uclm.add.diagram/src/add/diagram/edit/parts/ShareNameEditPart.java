 ...
 * @generated
 */
public class ShareNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(AddVisualIDRegistry.getType(add.diagram.edit.parts.ShareNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ShareNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Share_2014, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.ShareNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ShareLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ShareLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ShareLabelFigure() {
			this.setText("Share");
		}
