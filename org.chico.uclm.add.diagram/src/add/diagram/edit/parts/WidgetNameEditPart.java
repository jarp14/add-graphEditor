 ...
 * @generated
 */
public class WidgetNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Widget_2011, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.WidgetNameEditPart.VISUAL_ID));
		}
		return parser;
	}
