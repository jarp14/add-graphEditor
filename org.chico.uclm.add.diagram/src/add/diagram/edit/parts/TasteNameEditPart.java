 ...
 * @generated
 */
public class TasteNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(AddVisualIDRegistry.getType(add.diagram.edit.parts.TasteNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public TasteNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Taste_2003, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.TasteNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new TasteLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TasteLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TasteLabelFigure() {
			this.setText("Taste");
		}
