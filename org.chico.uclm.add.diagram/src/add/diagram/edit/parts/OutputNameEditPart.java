...
public class OutputNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Output_2008, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.OutputNameEditPart.VISUAL_ID));
		}
		return parser;
	}
