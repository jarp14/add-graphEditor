 ...
 * @generated
 */
public class SightNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(AddVisualIDRegistry.getType(add.diagram.edit.parts.SightNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public SightNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Sight_2001, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.SightNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new SightLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SightLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SightLabelFigure() {
			this.setText("Sight");
		}
