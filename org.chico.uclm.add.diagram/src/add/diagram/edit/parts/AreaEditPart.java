...
import add.diagram.edit.policies.AreaItemSemanticEditPolicy;
...
public class AreaEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AreaItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AreaTextEditPart) {
			((AreaTextEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAreaLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(AddVisualIDRegistry.getType(AreaTextEditPart.VISUAL_ID));
	}
