 ...
 * @generated
 */
public class ControllerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Controller_2013, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.ControllerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
