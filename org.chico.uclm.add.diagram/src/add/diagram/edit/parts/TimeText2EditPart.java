 ...
 * @generated
 */
public class TimeText2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TimeText2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Time_3004, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.TimeText2EditPart.VISUAL_ID));
		}
		return parser;
	}
