 ...
 * @generated
 */
public class AwarenessNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AwarenessNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Awareness_2010, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.AwarenessNameEditPart.VISUAL_ID));
		}
		return parser;
	}
