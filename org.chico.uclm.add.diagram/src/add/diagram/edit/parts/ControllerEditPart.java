...
import add.diagram.edit.policies.ControllerItemSemanticEditPolicy;
...
public class ControllerEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ControllerNameEditPart) {
			((ControllerNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureControllerLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(AddVisualIDRegistry.getType(ControllerNameEditPart.VISUAL_ID));
	}
