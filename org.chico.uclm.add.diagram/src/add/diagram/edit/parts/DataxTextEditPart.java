 ...
 * @generated
 */
public class DataxTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DataxTextEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Datax_3006, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.DataxTextEditPart.VISUAL_ID));
		}
		return parser;
	}
