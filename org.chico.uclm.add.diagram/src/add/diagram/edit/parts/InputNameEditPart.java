...
public class InputNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AddParserProvider.getParser(AddElementTypes.Input_2007, getParserElement(),
					AddVisualIDRegistry.getType(add.diagram.edit.parts.InputNameEditPart.VISUAL_ID));
		}
		return parser;
	}
