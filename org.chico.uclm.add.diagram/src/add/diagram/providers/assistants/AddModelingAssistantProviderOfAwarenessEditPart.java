 ...
 * @generated
 */
public class AddModelingAssistantProviderOfAwarenessEditPart extends AddModelingAssistantProvider {
	...
	*/
	...
	public List<IElementType> getTypesForPopupBar(IAdaptable host) {
		...
		types.add(AddElementTypes.Area_3007);
		types.add(AddElementTypes.Dimension_3008);
		types.add(AddElementTypes.Element_3009);
		return types;
	}
	...
	*/
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((AwarenessEditPart) sourceEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSource(AwarenessEditPart source) {
	...
	*/
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget((AwarenessEditPart) sourceEditPart, targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSourceAndTarget(AwarenessEditPart source,
	...
	*/
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((AwarenessEditPart) sourceEditPart, relationshipType);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetTypesForTarget(AwarenessEditPart source, IElementType relationshipType) {
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((AwarenessEditPart) targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnTarget(AwarenessEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(4);
		types.add(AddElementTypes.NormalLink_4001);
		types.add(AddElementTypes.SolidLink_4002);
		types.add(AddElementTypes.SolidGreyLink_4003);
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((AwarenessEditPart) targetEditPart, relationshipType);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(AwarenessEditPart target, IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == AddElementTypes.NormalLink_4001) {
			types.add(AddElementTypes.Input_2007);
			types.add(AddElementTypes.Output_2008);
