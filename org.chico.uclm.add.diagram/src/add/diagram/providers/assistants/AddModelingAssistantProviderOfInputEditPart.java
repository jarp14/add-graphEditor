 ...
 * @generated
 */
public class AddModelingAssistantProviderOfInputEditPart extends AddModelingAssistantProvider {
	...
	*/
	...
	public List<IElementType> getTypesForPopupBar(IAdaptable host) {
		...
		types.add(AddElementTypes.Interaction_3001);
		types.add(AddElementTypes.Time_3002);
		types.add(AddElementTypes.Event_3003);
		return types;
	}
